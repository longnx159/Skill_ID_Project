> Historical implementation snapshot. For the current runner, reporting contract, and verified behavior, see [docs/RUN_OPERATIONS.md](docs/RUN_OPERATIONS.md). Numerical results below belong to older runs.
